...
db.version(5).stores({
  ...
  goals: '++id, user_id, title, category, size, status, color, target_date, created_at',
  goal_milestones: '++id, user_id, goal_id, title, done, created_at',
  offlineQueue: '++id, table, operation, payload, created_at',
});
...
db.version(6).stores({
  ...
  goals: '++id, user_id, title, category, size, status, color, target_date, created_at',
  goal_milestones: '++id, user_id, goal_id, title, done, created_at',
  credit_cards: '++id, user_id, name, credit_limit, current_balance, created_at',
  credit_card_plans: '++id, user_id, card_id, name, monthly_amount, payments_left, created_at',
  credit_card_monthly: '++id, user_id, card_id, month, amount, closed, created_at',
  offlineQueue: '++id, table, operation, payload, created_at',
});
